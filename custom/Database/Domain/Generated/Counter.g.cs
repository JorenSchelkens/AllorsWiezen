...
namespace Allors.Domain
{
	public partial class Counter : Allors.IObject , UniquelyIdentifiable
	{
		...
		virtual public Settings SettingsWhereCounter
		{ 
			get
			{
				return (Settings) Strategy.GetCompositeAssociation(Meta.SettingsWhereCounter.RelationType);
			}
		} 

		virtual public bool ExistSettingsWhereCounter
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.SettingsWhereCounter.RelationType);
			}
		}
