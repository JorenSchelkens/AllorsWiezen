...
namespace Allors.Domain
{
	public partial class Singleton : Allors.IObject , AccessControlledObject
	{
		...
		{ 
			get
			{
				return (Settings) Strategy.GetCompositeRole(Meta.Settings.RelationType);
			}
			set
			{
				Strategy.SetCompositeRole(Meta.Settings.RelationType, value);
			}
		}

		virtual public bool ExistSettings
		{
			get
			{
				return Strategy.ExistCompositeRole(Meta.Settings.RelationType);
			}
		}

		virtual public void RemoveSettings()
		{
			Strategy.RemoveCompositeRole(Meta.Settings.RelationType);
		}
		...
		virtual public global::Allors.Extent<Locale> AdditionalLocales
		{ 
			get
			{
				return Strategy.GetCompositeRoles(Meta.AdditionalLocales.RelationType);
			}
			set
			{
				Strategy.SetCompositeRoles(Meta.AdditionalLocales.RelationType, value);
			}
		}

		virtual public void AddAdditionalLocale (Locale value)
		{
			Strategy.AddCompositeRole(Meta.AdditionalLocales.RelationType, value);
		}

		virtual public void RemoveAdditionalLocale (Locale value)
		{
			Strategy.RemoveCompositeRole(Meta.AdditionalLocales.RelationType, value);
		}

		virtual public bool ExistAdditionalLocales
		{
			get
			{
				return Strategy.ExistCompositeRoles(Meta.AdditionalLocales.RelationType);
			}
		}

		virtual public void RemoveAdditionalLocales()
		{
			Strategy.RemoveCompositeRoles(Meta.AdditionalLocales.RelationType);
		}
	...
	{		
		...
		protected override void OnBuild(Singleton instance)
		{
			...
			{
				instance.AdditionalLocales = this.AdditionalLocales.ToArray();
			}
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public SingletonBuilder WithSettings(Settings value)
		        {
		            if(this.Settings!=null){throw new global::System.ArgumentException("One multicplicity");}
					this.Settings = value;
		            return this;
		        }		
				...
				public global::System.Collections.Generic.List<Locale> AdditionalLocales {get; set;}	

				/// <exclude/>
				public SingletonBuilder WithAdditionalLocale(Locale value)
		        {
					if(this.AdditionalLocales == null)
					{
						this.AdditionalLocales = new global::System.Collections.Generic.List<Locale>(); 
					}
		            this.AdditionalLocales.Add(value);
		            return this;
		        }		
				...
				/// <exclude/>
				public SingletonBuilder WithLogoImage(Media value)
		        {
