...
namespace Allors.Domain
{
	public partial class Locale : Allors.IObject , AccessControlledObject
	{
		...
		virtual public Singleton SingletonWhereAdditionalLocale
		{ 
			get
			{
				return (Singleton) Strategy.GetCompositeAssociation(Meta.SingletonWhereAdditionalLocale.RelationType);
			}
		} 

		virtual public bool ExistSingletonWhereAdditionalLocale
		{
			get
			{
				return Strategy.ExistCompositeAssociation(Meta.SingletonWhereAdditionalLocale.RelationType);
			}
		}
