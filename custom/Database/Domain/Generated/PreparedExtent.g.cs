...
{
	public partial class PreparedExtent : Allors.IObject , UniquelyIdentifiable, Deletable
	{
		private readonly IStrategy strategy;

		public PreparedExtent(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaPreparedExtent Meta
		{
			get
			{
				return Allors.Meta.MetaPreparedExtent.Instance;
			}
		}
		...
		public static PreparedExtent Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (PreparedExtent) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		{ 
			var method = new PreparedExtentOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PreparedExtentOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PreparedExtentOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PreparedExtentOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PreparedExtentOnPostDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new PreparedExtentDelete(this);
            method.Execute();
            return method;
		}
	...
	public partial class PreparedExtentBuilder : Allors.ObjectBuilder<PreparedExtent> , UniquelyIdentifiableBuilder, DeletableBuilder, global::System.IDisposable
	{		
		public PreparedExtentBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(PreparedExtent instance)
		{
			...
			if(this.UniqueId.HasValue)
			{
				...
				/// <exclude/>
				public PreparedExtentBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public PreparedExtentBuilder WithDescription(global::System.String value)
		        {
				...
				/// <exclude/>
				public PreparedExtentBuilder WithContent(global::System.String value)
		        {
				...
				/// <exclude/>
				public PreparedExtentBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class PreparedExtents : global::Allors.ObjectsBase<PreparedExtent>
	{
		public PreparedExtents(Allors.ISession session) : base(session)
		{
		}
