...
{
	public partial class TemplateType : Allors.IObject , Enumeration, Deletable
	{
		private readonly IStrategy strategy;

		public TemplateType(Allors.IStrategy strategy) 
		{
			this.strategy = strategy;
		}

		public Allors.Meta.MetaTemplateType Meta
		{
			get
			{
				return Allors.Meta.MetaTemplateType.Instance;
			}
		}
		...
		public static TemplateType Instantiate (Allors.ISession allorsSession, string allorsObjectId)
		{
			return (TemplateType) allorsSession.Instantiate(allorsObjectId);		
		}
		...
		virtual public global::Allors.Extent<Template> TemplatesWhereTemplateType
		{ 
			get
			{
				return Strategy.GetCompositeAssociations(Meta.TemplatesWhereTemplateType.RelationType);
			}
		}

		virtual public bool ExistTemplatesWhereTemplateType
		{
			get
			{
				return Strategy.ExistCompositeAssociations(Meta.TemplatesWhereTemplateType.RelationType);
			}
		}
		...
		{ 
			var method = new TemplateTypeOnBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TemplateTypeOnPostBuild(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TemplateTypeOnPreDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TemplateTypeOnDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TemplateTypeOnPostDerive(this);
            method.Execute();
            return method;
		}
		...
		{ 
			var method = new TemplateTypeDelete(this);
            method.Execute();
            return method;
		}
	...
	public partial class TemplateTypeBuilder : Allors.ObjectBuilder<TemplateType> , EnumerationBuilder, DeletableBuilder, global::System.IDisposable
	{		
		public TemplateTypeBuilder(Allors.ISession session) : base(session)
	    {
	    }

		protected override void OnBuild(TemplateType instance)
		{
			...
			if(this.SecurityTokens!=null)
			{
				...
				/// <exclude/>
				public TemplateTypeBuilder WithName(global::System.String value)
		        {
				...
				/// <exclude/>
				public TemplateTypeBuilder WithLocalisedName(LocalisedText value)
		        {
					if(this.LocalisedNames == null)
					{
				...
				/// <exclude/>
				public TemplateTypeBuilder WithIsActive(global::System.Boolean? value)
		        {
				...
				/// <exclude/>
				public TemplateTypeBuilder WithDeniedPermission(Permission value)
		        {
					if(this.DeniedPermissions == null)
					{
				...
				/// <exclude/>
				public TemplateTypeBuilder WithSecurityToken(SecurityToken value)
		        {
					if(this.SecurityTokens == null)
					{
				...
				/// <exclude/>
				public TemplateTypeBuilder WithUniqueId(global::System.Guid? value)
		        {
	...
	public partial class TemplateTypes : global::Allors.ObjectsBase<TemplateType>
	{
		public TemplateTypes(Allors.ISession session) : base(session)
		{
		}
