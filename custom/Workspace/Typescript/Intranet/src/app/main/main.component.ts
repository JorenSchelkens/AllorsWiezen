...
import { StateService } from '../../allors/material/custom/services/state/state.service';
...
export class MainComponent implements OnInit, OnDestroy {
  ...
  public ngOnInit(): void {
    ...
    this.subscription = this.stateService.organisationId$
      .pipe(
      ...
      .subscribe((loaded: Loaded) => {
        ...
        this.selectedOrganisation = loaded.objects.Organisation as Organisation;
      });
  }
